...
class TicToc extends React.Component {
  ...
  render() {
    return (
      <div>Current time {this.props.cityName}: {this.state.initialDate.toLocaleTimeString({}, {timeZone: this.props.timeZone})} </div>
    );
  }
}
...
ReactDOM.render(
  <div>
    <TicToc cityName="Amsterdam" />
    <TicToc cityName="New York" timeZone="America/New_York"/>
    <TicToc cityName="Hong Kong" timeZone="Asia/Hong_Kong"/>
  </div>,
